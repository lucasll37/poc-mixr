...
//
// Uma unica questao: transformar o .edl em objetos vivos e conferir que o
...
// do tempo. Trocar por ( Station ) no .edl continua rodando -- so sem as
...
// Station. Um cenario sem essa secao (ou um .edl mais antigo) continua
