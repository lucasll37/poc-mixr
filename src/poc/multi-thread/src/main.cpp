...
int main(int argc, char* argv[])
{
   ...
   mixr::xlog::init("./src/poc/multi-thread/data/logs/multi-thread.log");

   app::Options defaults;
   defaults.templatePath  = "./src/poc/multi-thread/configs/scenario.epp.in";
   defaults.generatedPath = "./src/poc/multi-thread/configs/scenario.generated.epp";
