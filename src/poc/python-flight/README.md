...
| o nó de árvore `( PyDecide )` | `models/flight/src/bt/nodes/PyDecideAction.cpp` |
...
* um **subprojeto completo** em cima daquelas peças: cenário próprio, árvore própria, quatro
  ...
  de testes de sempre. Antes havia um `flight_tree_py.xml` de **exemplo** no `models/flight`, com
