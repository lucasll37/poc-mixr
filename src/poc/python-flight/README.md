...
```bash
./build/app/src/app -folder src/poc -scenario python-flight                       # veja o voo no Tacview
...
Para ver o voo: `./build/app/src/app -folder src/poc -scenario python-flight` e conecte o Tacview em `File > Real-Time Telemetry`,
porta **1237**.
