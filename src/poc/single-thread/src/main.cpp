...
// tempo critico (ver src/poc/multi-thread, que troca so essa peca).
//
...
int main(int argc, char* argv[])
{
   ...
   mixr::xlog::init("./src/poc/single-thread/data/logs/single-thread.log");

   app::Options defaults;
   defaults.templatePath  = "./src/poc/single-thread/configs/scenario.epp.in";
   defaults.generatedPath = "./src/poc/single-thread/configs/scenario.generated.epp";
