...
// 'src/bandit-dis' do CLAUDE.md para o desenho completo.
//
...
const std::string scenarioPath{"./src/bandit-dis/configs/scenario.epp"};
...
int main()
{
   mixr::xlog::init("./src/bandit-dis/data/logs/bandit-dis.log");
