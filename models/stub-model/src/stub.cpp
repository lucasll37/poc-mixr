...
//
// Este arquivo nao inclui, nao le e nao conhece nada de models/flight-model.
...
// sem erro nenhum. Ver models/stub-model/CONTRATO.md.
//
...
public:
   ...
   //
   // Note que isto NAO usa o RadarScan do flight-model: este projeto nao
