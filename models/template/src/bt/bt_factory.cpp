...
// registerNodeType so existe em versoes posteriores -- este repositorio esta
// preso na 3.5.6, ver contexts/BTCPP-CONTEXT.md).
...
// O ID (primeiro argumento) e o nome da TAG no XML, nao o nome da classe C++
// -- e o que o Groot mostra na paleta e o que configs/*.xml escreve.
//
...
{
   registerWithContext<ExampleThresholdCondition>(factory, "ExampleThreshold", context);
   registerWithContext<ExampleLabelAction>(factory, "ExampleLabel", context);
}
