...
//              ponte Python entregou, lido de libs/xrlbridge.
//
// Factory name: RLBridgeBehavior
//
// Slots: (nenhum) -- a configuracao vem de fora, por libs/xrlbridge, nao de
// EDL.
//
// POR QUE libs/xrlbridge E NAO UM PONTEIRO ESTATICO NESTA CLASSE: esta
...
// libs/xrlbridge/RLBridge.hpp para o protocolo completo.
//
