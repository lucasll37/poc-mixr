...
// models/player/A4/src/ubf/FlightAction.cpp ou
// models/player/fixtures/stub/src/stub.cpp fazem -- leia os dois quando for a
...
// models/player/fixtures/stub/docs/CONTRATO.md secao 3. E a UNICA obrigacao de
