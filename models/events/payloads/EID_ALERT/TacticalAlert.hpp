...
//
// Movida de models/players/air/A-4/xnative/ para ca (ver events/README.md): um
...
// models/players/air/A-4 em vez de virar plugin proprio). Continua com o MESMO nome
