...
// ponto de partida do valor medido em models/players/air/A-4 (3.0 deg/s, contra um
...
// ja documentado em models/players/air/A-4: um controlador SO proporcional fica
...
BT::NodeStatus NavigateAction::tick()
{
   ...
   if (!view.hasNavSteering) {
      ...
      // models/players/air/A-4/src/bt/nodes/NavigateAction.cpp.
