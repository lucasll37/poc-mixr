...
monta o cenário, feita depois, em outro lugar (`CONTRIBUTING.md` §6 na raiz,
...
```bash
cd ../../../.. && make open-groot
# File > Load... > models/players/air/A-4/configs/flight_tree.xml
```
...
make create-bt
cd ../../../.. && make open-groot
# File > Load... > models/players/air/A-4/configs/bt.xml
```
...
`CONTRIBUTING.md` §6 (raiz) para essa parte, se for você quem for fazer os dois.
