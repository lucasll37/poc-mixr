...
//
// O SimAgent nativo faz o contrario: mora na Station e resolve o ator por
// NOME, procurando na lista de players do WorldModel. Aqui basta subir a
// cadeia de containers -- e o bloco EDL fica identico para as quatro
// aeronaves.
//------------------------------------------------------------------------------
...
// BaseClass::shutdownNotification() (Component::shutdownNotification(),
// ja que nem AgentTC nem Agent sobrescrevem) continua propagando o evento
// para os subcomponentes do proprio agente (ex.: 'state', adicionado via
// addComponent() em Agent::setState()).
//------------------------------------------------------------------------------
