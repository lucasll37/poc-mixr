...
//
// 'decisions'/'lastThreadTag' sao bookkeeping interno (uma decisao por
// frame; a tag da thread do pool T/C que decidiu) -- nao expostos por
// getter publico: quem consome isso de fora do plugin e' o quadro de
// leitura (libs/xboard::Readout), publicado em controller() logo abaixo,
// nao estes contadores. Mantidos porque sao baratos e podem servir de
// bookkeeping interno futuro, mas hoje ninguem os le de volta.
//------------------------------------------------------------------------------
