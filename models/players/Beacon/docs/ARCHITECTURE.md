...
`xnative::AlertDatalink::onDatalinkMessageEvent()` (`models/players/A-4`) — duas classes
...
`models/players/A-4` acrescentar `TacticalAlert` ao seu: `xplugin::pluginMetaObjects()` (a fonte da
