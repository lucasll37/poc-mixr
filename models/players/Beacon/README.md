...
registro) e `src/plugin.cpp` (a fronteira C) é a MESMA de `models/players/A-4`, só que com duas
...
`xnative::AlertDatalink::broadcastAlert()` (`models/players/A-4`): todo `Beacon` local ativo,
