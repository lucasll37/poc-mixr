...
cd models/players/fixtures/stub
...
```bash
cp -r models/players/fixtures/stub models/meu-modelo
...
`models/players/fixtures/`). Um modelo novo criado direto em `models/meu-modelo/` está só dois níveis
