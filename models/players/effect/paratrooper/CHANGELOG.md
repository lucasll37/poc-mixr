...
- **Ponto de saída**: um paraquedista liberado de uma aeronave nasce **15 m atrás e 10 m abaixo**
  ...
  Medido contra o C-130 de `models/players/air/C-130` liberando pelo `StoresMgr` de verdade: 15,001 m
...
- Corpo físico (`xnative::Paratrooper`, deriva de `mixr::models::Effect`) e decisão (FSM de três
  ...
  `C130ParatrooperPlaceholder` (`models/players/air/C-130`) numa tarefa futura.
- `xnative::ParatrooperAgentTC` (fase 3 do frame de tempo crítico, adaptado de
  `models/players/air/C-130/src/xnative/FlightAgentTC.cpp`) e uma rede de segurança contra o
...
- Suíte de 4 camadas (domain/tree/native/contract, mesmo padrão de `models/players/air/C-130`) — 26
