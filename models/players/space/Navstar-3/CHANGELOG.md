...
- `xnative::Navstar3AgentTC` (fase 3 do frame de tempo crítico, adaptado de
  `models/players/effect/paratrooper/src/xnative/ParatrooperAgentTC.cpp`) — nenhuma classe de "corpo
...
- Suíte de 4 camadas (domain/tree/native/contract, mesmo padrão de `models/players/effect/paratrooper`)
