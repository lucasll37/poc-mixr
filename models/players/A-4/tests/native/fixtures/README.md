...
python3 src/poc/rl-training/tools/export_onnx.py --random --fields all \
  -o models/players/A-4/tests/native/fixtures/policy_all38.onnx

python3 src/poc/rl-training/tools/export_onnx.py --random --fields "northM eastM altitudeM" \
  -o models/players/A-4/tests/native/fixtures/policy_3fields.onnx

python3 src/poc/rl-training/tools/export_onnx.py --random \
  -o models/players/A-4/tests/native/fixtures/policy_classic28_metadata_divergente.onnx
```
...
```python
import onnx
caminho = "models/players/A-4/tests/native/fixtures/policy_classic28_metadata_divergente.onnx"
