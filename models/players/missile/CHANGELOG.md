...
- **O diretório pai passou de `models/player/` para `models/players/`** — este projeto passou a
  morar em `models/players/missile/`. `git mv`, histórico preservado. Detalhe da varredura →
...
- **A definição JSBSim do míssil (`aim1.xml`) mora em `models/players/A-4/data/jsbsim/aircraft/aim1/`**,
