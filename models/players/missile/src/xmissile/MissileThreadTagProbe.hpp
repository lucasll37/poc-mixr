...
//
// Mesma classe/motivo de models/players/A-4/xnative/ThreadTagProbe (ver o
...
// models/players/A-4). O missil (GuidedMissile) tambem nao tem UBF/agente
...
// registro de plugins (libs/xplugin/PluginRegistry.cpp) recusa a carga
...
// sandbox/intercept_missile/configs/scenario_intercept_missile.edl.in) -- entao os DOIS nomes tem de ser
...
// compartilhada entre este plugin e o flight, porque mora em libs/xboard
