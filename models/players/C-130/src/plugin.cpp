...
{
   return (name != nullptr) ? mixr::models::xC_130::factory(std::string{name}) : nullptr;
}
...
// ==========================================================================
MIXR_PLUGIN_DEFINE("C-130",
                   fabrica,
                   mixr::models::xC_130::factoryNames(),
                   mixr::models::xC_130::metaObjects())
