...
{
   return (name != nullptr) ? mixr::models::xparatrooper::factory(std::string{name}) : nullptr;
}
...
// ==========================================================================
MIXR_PLUGIN_DEFINE("paratrooper",
                   fabrica,
                   mixr::models::xparatrooper::factoryNames(),
                   mixr::models::xparatrooper::metaObjects())
