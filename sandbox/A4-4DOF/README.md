...
O dump mostra `fuel=0.000000000` e `mach=0.000000000` o tempo todo — **não é um defeito desta
variante**. Explicação central: [`sandbox/README.md`](../README.md#por-que-o-combustível-aparece-zerado-no-dump).
