...
public:
   ...
   // Remove um objeto da cena (formato oficial ACMI "-<idHex>") -- usado
   // pra chaff/flare/decoy sumirem no replay quando expiram, em vez de
   // ficarem "fantasmas" parados na ultima posicao conhecida.
