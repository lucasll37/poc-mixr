...
| 4 | Física de voo completa (6 graus de liberdade) via JSBSim, o simulador de voo já integrado ao MIXR | `models/player/A4/` |
...
| 6 | Lógica de decisão como uma árvore de comportamento (BehaviorTree.CPP) carregada de um arquivo XML — trocar a política não recompila nada | `models/player/A4/src/bt/` |
