 ...
 *
 * MODEL, FACTORIES, SNIPPETS e STATS são GERADOS por tools/extract_execution_chain.py
...
function ClassCard({ c, onClose, onOpen }) {
  ...
  // TARGET_METHODS, ver tools/extract_execution_chain.py) já têm corpo
