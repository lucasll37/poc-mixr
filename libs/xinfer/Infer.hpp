...
//
// Mesmo argumento estrutural de libs/xboard/Board.hpp e libs/xrlbridge/
...
//      depois de linkado (537 MB so de debug info). models/players/air/A-4/meson.build
...
//      libs/xplugin/README.md ja aponta como a honesta.
//
...
// libs/xjoystick e da arvore que nao carrega em ubf/BtBehavior).
using ModelId = int;
