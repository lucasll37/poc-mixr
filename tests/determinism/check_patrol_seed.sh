...
# '$(dirname "$BIN")/../../../<rotulo>-{sufixo}') -- esse calculo so acerta
# um lugar sensato enquanto o binario mora a uma profundidade fixa
# especifica, e quebra em silencio (aterrissando na raiz do repositorio) se
# essa profundidade mudar. Sai de RAIZ, explicitamente, e vai para 'build/'
# junto com os outros
