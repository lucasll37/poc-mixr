...
|---|---|---|---|
| `domain` (modelo) | as regras estão certas? | GTest sobre `models/A4/src/domain/`, sem MIXR e sem BT.CPP | 42 testes, ~10 ms |
...
[`domain/ThreatPolicy.hpp`](../models/A4/include/domain/ThreatPolicy.hpp): três correções
...
## Camada 2 — a árvore ([tree/](../models/A4/tests/tree/))

Carrega o
[`flight_tree.xml` de produção](../models/A4/configs/flight_tree.xml) — por caminho, não
...
>
> 1. `FlightState::Snapshot` virou [`domain::WorldView`](../models/A4/include/domain/WorldView.hpp),
...
>    [`bt_nodes::DecisionContext`](../models/A4/include/bt/DecisionContext.hpp), a interface
