...
src/{single-thread,multi-thread}/configs/scenario.epp.in).
...
src/multi-thread/configs/scenario.epp.in -- a ordem de
...
Uso:
    python3 skeleton_diff.py <arquivo.epp.in> falcon1 falcon2 falcon3 falcon4
